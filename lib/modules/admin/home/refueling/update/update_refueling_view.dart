...
class UpdateRefuelingView extends GetView<UpdateRefuelingController> {
  const UpdateRefuelingView({super.key});
                ...
                children: [
                  ...
                  Obx(
                    () => TextInputFieldWithController(
                      ...
                      inputAction: TextInputAction.next,
                      type: TextInputType.number,
                      onChange: (value) => controller.onLitersChanged(value),
                      onTap: () {},
                      onSaved: (value) {},
                      onValidate: (value) {
                        if (value == null || value.isEmpty) {
                                    ...
                                    () => Stack(
                                      ...
                                      children: [
                                        ...
                                        if (controller
                                            ...
                                            .value
                                            .isNotEmpty)
                                          controller.filePath.value.startsWith(
                                                'http',
                                              )
                                              ? Image.network(
